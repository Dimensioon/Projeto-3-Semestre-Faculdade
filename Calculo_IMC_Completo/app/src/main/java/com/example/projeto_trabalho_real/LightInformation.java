...
public class LightInformation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightinformation);
        ...
        masculino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent masculino = new Intent(getApplicationContext(), LightMasculino.class);
                ...
                Toast.makeText(LightInformation.this, "Verifique os erros: "+ erros, Toast.LENGTH_SHORT).show();//Detectado erros
            }}
        });
        ...
        feminino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent feminino = new Intent(getApplicationContext(), LightFeminino.class);
