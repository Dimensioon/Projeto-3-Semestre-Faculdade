...
public class LightFeminino extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightfeminino);
        ...
        Intent feminino = getIntent();

        Bundle dadosf = feminino.getExtras();

        nome.setText("Ola " + dadosf.getString("nome") + ".");
        peso.setText("Seu peso é: " + dadosf.getString("peso") + " KG.");
        altura.setText("Sua altura é: " + dadosf.getString("altura") + " Metros.");
        imc.setText("Seu IMC é: " + dadosf.getString("imc") + ".");

        Double resultado = Double.parseDouble(dadosf.getString("imc"));
